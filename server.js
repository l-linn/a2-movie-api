...
mongoose.connect('mongodb+srv://lin7cb:c3lJ78n0A23nLqFp@cluster0.vkzg8pg.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.get('/movies/genre/:type', passport.authenticate('jwt', {session: false}), (req, res) => {
...
app.put('/users/:username/profile', passport.authenticate('jwt', {session: false}), (req, res) => {
...
app.delete('/users/:username/setting', passport.authenticate('jwt', {session: false}), (req, res) => {
